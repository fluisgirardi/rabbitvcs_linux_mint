#!/bin/bash
sudo apt install git subversion nemo-python python-svn python3-svn python-simplejson python3-simplejson meld nemo nemo-python python-dbus python-dulwich python3-dulwich python-git python3-git python-tk
cd /tmp
